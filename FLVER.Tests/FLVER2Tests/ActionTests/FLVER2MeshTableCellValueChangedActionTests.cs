...
public class FLVER2MeshTableCellValueChangedActionTests : IClassFixture<DataFixture>
{
    private readonly DataFixture dataFixture;

    public FLVER2MeshTableCellValueChangedActionTests(DataFixture dataFixture)
    {
