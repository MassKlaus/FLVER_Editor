...
public class FLVER2BonesTableCellValueUpdatedActionTests : IClassFixture<DataFixture>
{
    private readonly DataFixture dataFixture;

    public FLVER2BonesTableCellValueUpdatedActionTests(DataFixture dataFixture)
    {
