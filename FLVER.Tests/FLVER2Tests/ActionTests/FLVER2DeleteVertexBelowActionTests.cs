...
public class FLVER2DeleteVertexBelowActionTests : IClassFixture<DataFixture>
{
    private readonly DataFixture dataFixture;

    public FLVER2DeleteVertexBelowActionTests(DataFixture dataFixture)
    {
        this.dataFixture = dataFixture;
    }

    [Fact]
    public void DeleteAllVertexLowerThanTargetThenUndo()
    {
        ...
        DeleteVertexBelowAction action = new(mesh, height, () => { });
        action.Execute();
